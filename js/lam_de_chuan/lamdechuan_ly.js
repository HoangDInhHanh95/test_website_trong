...
function createExam() {
    ...
    const abcdQuestions = getRandomQuestions(questions.ly.abcd, 18);
    const dungSaiQuestions = getRandomQuestions(questions.ly.dung_sai, 4);
    const traLoiNganQuestions = getRandomQuestions(questions.ly.tra_loi_ngan, 6);
...
function displayResults(answers) {
    ...
    <div class="results-header">
        ...
        <div class="nav-buttons">
            ...
            <a href="lamdechuan_ly.html" class="nav-button">Làm Đề Khác</a>
        </div>
    </div>
...
console.log("lamdechuan_ly.js loaded");
